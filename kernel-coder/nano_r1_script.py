"""
This script is used to train the RL model for Triton kernel generation.

It is based on the [nano-aha-moment](https://github.com/McGill-NLP/nano-aha-moment/blob/f6384878831796fc29f560016e3cd570d264b823/nano_r1_script.py) project.
